...
def hometown_info():
    ...
    home_town_massage= f"i was born in {home_town['city:']} {home_town['state:']} - population of {home_town['population:']}"
    return home_town_massage
# Call the function and print the result
...
def list_home_town_items():
    ...
    for key, value in home_town.items():
        home_town_item.append(f'{key} = {value}')
    return home_town_item
